...
class Html5QrcodeScanner {
    ...
    __createSectionControlPanel() {
        ...
        requestPermissionButton.setAttribute("id", "buscar_cam");
        requestPermissionButton.setAttribute("class", "fas fa-camera-retro");
        //requestPermissionButton.innerHTML = "Escanear";
    ...
    __renderCameraSelection(cameras) {
        ...
        cameraSelectionContainer.innerHTML
            = `Seleccionar Camara (${cameras.length}) &nbsp;`;
        ...
        //cameraActionContainer.setAttribute("id", "escanea");
        const cameraActionStartButton = document.createElement("button");
        cameraActionStartButton.setAttribute("id", "escanear");
        cameraActionStartButton.innerHTML = "Escanea";
